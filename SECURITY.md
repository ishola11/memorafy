...
Memora is a clipboard manager — it handles some of the most sensitive data on
a computer. Security reports are taken seriously and handled with priority.
...
- Alternatively: email **fred@appenbase.com** with a description and
  reproduction steps.
...
- **Concealed-content exclusion** — clips marked confidential by their
  ...
  (currently implemented on Windows; macOS pending).
